...
void ASpeedPickup::BeginPlay()
{
	...
	_collisionSphere->OnComponentBeginOverlap.AddDynamic(this, &ASpeedPickup::OnPickupSphereOverlap);
}

void ASpeedPickup::SetItemProperties(EItemState state)
{
...
void ASpeedPickup::OnPickupSphereOverlap(UPrimitiveComponent* overlappedComponent, AActor* otherActor,

...
void ADamagePickup::Tick(float deltaSeconds)
{
...
void ADamagePickup::BeginPlay()
{
	...
	_collisionSphere->OnComponentBeginOverlap.AddDynamic(this, &ADamagePickup::OnPickupSphereOverlap);
}

void ADamagePickup::SetItemProperties(EItemState state)
{
...
void ADamagePickup::OnPickupSphereOverlap(UPrimitiveComponent* overlappedComponent, AActor* otherActor,

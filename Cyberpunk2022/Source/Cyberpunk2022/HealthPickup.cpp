...
void AHealthPickup::BeginPlay()
{
	...
	_collisionSphere->OnComponentBeginOverlap.AddDynamic(this, &AHealthPickup::OnPickupSphereOverlap);
}

void AHealthPickup::SetItemProperties(EItemState state)
{
...
void AHealthPickup::OnPickupSphereOverlap(UPrimitiveComponent* overlappedComponent, AActor* otherActor,

...
// End Cross Module References
	void ITakingDamageInterface::TakingDamage(FName bone, int32 damage, AActor* instigator)
	{
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UTakingDamageInterface_TakingDamage_Statics::NewProp_instigator = { "instigator", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(TakingDamageInterface_eventTakingDamage_Parms, instigator), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UTakingDamageInterface_TakingDamage_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UTakingDamageInterface_TakingDamage_Statics::NewProp_instigator,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTakingDamageInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTakingDamageInterface_TakingDamage, "TakingDamage" }, // 693810954
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UTakingDamageInterface, 2965143001);
	...
	void ITakingDamageInterface::Execute_TakingDamage(UObject* O, FName bone, int32 damage, AActor* instigator)
	{
		check(O != NULL);
